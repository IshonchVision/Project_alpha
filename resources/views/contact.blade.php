...
<div class="jumbotron jumbotron-fluid page-header position-relative overlay-bottom" style="margin-bottom: 90px;">
    <div class="container text-center py-5">
        <h1 class="text-white display-1">Kontakt</h1>
    </div>
</div>
<!-- Header End -->
        ...
        <div class="row align-items-center">
            <div class="col-lg-5 mb-5 mb-lg-0">
                <div class="bg-light d-flex flex-column justify-content-center px-5" style="height: 450px;">
                    <div class="d-flex align-items-center mb-5">
                        ...
                        <div class="mt-n1">
                            <h4>Manzilimiz:</h4>
                            <p class="m-0">Toshkent sh. Bodomzor ko'chasi</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-5">
                        ...
                        <div class="mt-n1">
                            <h4>Telefon:</h4>
                            <p class="m-0">+998 90 123 45 67</p>
                        </div>
                    </div>
            ...
            <div class="col-lg-7">
                <div class="section-title position-relative mb-4">
                    <h6 class="d-inline-block position-relative text-secondary text-uppercase pb-2">Ko'proq ma'lumot uchun</h6>
                    ...
                    <form>
                        <div class="row">
                            <div class="col-6 form-group">
                                <input type="text" class="form-control border-top-0 border-right-0 border-left-0 p-0" placeholder="Ism" required="required">
                            </div>
                            <div class="col-6 form-group">
