                ...
                @if ($course->course_type === 'theory')
                    <div class="row align-items-center mb-5">
                        <div class="col-lg-4 col-md-6 pb-4">
                            <a class="courses-list-item position-relative d-block overflow-hidden shadow"
                                ...
                                <div class="courses-text"
                                    ...
                                    <div class="text-center mb-3">
                                        <h4 class="text-white m-0" style="font-weight: 700; font-size: 22px;">
                                            {{ $course->title }}</h4>
                                        <p class="text-white-50 mb-1 mt-1" style="font-size: 14px;">
                                            O'qituvchi: {{ $course->user->name ?? "O'qituvchi" }}
                                        </p>
                                    </div>
                                    <div
                                        style="width: 100%; height: 1px; background: rgba(255,255,255,0.2); margin-bottom: 15px;">
                                    </div>
                                    <div
                                        ...
                                        <span
                                            style="background-color: #ff8a50; color: white; padding: 6px 12px; border-radius: 25px; font-size: 12px; font-weight: 600;">Video
                                            kurs</span>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="col-lg-8 col-md-6 pb-4">
                            <a href="{{ route('course.detail', $course->id) }}"
                                ...
                                <div class="p-4 bg-white shadow-sm"
                                    style="border-radius: 15px; min-height: 450px; display: flex; flex-direction: column; justify-content: flex-start;">
                                    <div style="width: 100%;">
                                        <h4 class="text-primary border-bottom pb-2" style="font-weight: 700;">Kurs haqida
                                        </h4>
                                        <p
                                            style="white-space: pre-line; font-size: 18px; color: #444; line-height: 1.6; margin-top: 0 !important;">
        ...
        <div class="container py-5">
            ...
            <div class="row">
                @foreach ($courses->sortByDesc('created_at') as $course)
                    @if ($course->course_type !== 'theory')
                        <div class="col-lg-4 col-md-6 pb-4">
                            <a class="courses-list-item position-relative d-block overflow-hidden mb-2 shadow"
                                href="{{ route('course.detail', $course->id) }}"
                                style="border-radius: 15px; text-decoration: none; display: block; height: 450px;">
                        ...
                        padding: 30px 20px;">
                                    ...
                                    <div
                                        ...
                                        <span
                                            style="background-color: #ff8a50; color: white; padding: 8px 15px; border-radius: 25px; font-size: 13px; font-weight: 600;">Video
                                            kurs</span>
                                    </div>
                                </div>
                            </a>
